...
describe("schedule time helpers", () => {
  ...
  it("未選択の日程を一括追加し、選択済みの日程を重複追加しない", () => {
    const result = toggleScheduleDates(
      [
        {
          id: "11111111-1111-4111-8111-111111111111",
        ...
        {
          id: "22222222-2222-4222-8222-222222222222",
          startDate: "2026-07-29T09:00:00",
          endDate: "2026-07-29T10:00:00",
        },
      ],
    ...
    expect(result).toEqual([
      ...
      {
        startDate: "2026-08-12T22:00:00",
        endDate: "2026-08-13T01:00:00",
      },
      {
        startDate: "2026-08-19T22:00:00",
        endDate: "2026-08-20T01:00:00",
      },
      {
        startDate: "2026-08-26T22:00:00",
        endDate: "2026-08-27T01:00:00",
      },
    ]);
  });

  it("対象日がすべて選択済みなら対象日だけを一括解除する", () => {
    const result = toggleScheduleDates(
      [
        {
          id: "11111111-1111-4111-8111-111111111111",
